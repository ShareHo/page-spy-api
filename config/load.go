...
func LoadConfig() (*Config, error) {
	...
	c := &Config{Port: "6752", Debug:false, NotAllowedDeleteLog:false, RpcAddress: []*Address{}, CorsConfig: nil, StorageConfig: nil, MaxRoomNumber: 0, MaxLogFileSizeOfMB: 0, MaxLogLifeTimeOfHour: 0}
	// {6752 false false [] <nil> <nil> 0 0 0})
